...
group.add_option('--preprocess-current',  action='store_true',  dest='preprocess_current', help='enable preprocessing of the current computation in RT.')
...
add_option(dict, 'ENABLE_CURRENT_PREPROCESSING', options.preprocess_current)
