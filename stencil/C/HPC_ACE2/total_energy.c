...
)
{
  ...
  const _fjsp_v4r8 CONJ = _fjsp_set_v4r8(-1, 1, -1, 1);
  ...
  _fjsp_v4r8 zr = _fjsp_setzero_v4r8();
  _fjsp_v4r8 zi = _fjsp_setzero_v4r8();
...
#define STENCIL_LOAD(IDM,IDP,MM,PP) \
      ...
      _fjsp_v4r8 tu = _fjsp_eperm_v4(ut, sel);
                 tu = _fjsp_xor_v4r8(INV, tu);
      _fjsp_v4r8 v5 = _fjsp_add_v4r8(tt, tu);

      // z = A * e[iz] * z
      _fjsp_v4r8 v4 = _fjsp_madd_v4r8(at, ez, v5);

      // conj(e[iz]) * z
      _fjsp_v4r8 v3 = _fjsp_mul_v4r8(w, v4);
      _fjsp_v4r8 v2 = _fjsp_xor_v4r8(v3, INV);
      _fjsp_v4r8 v1 = _fjsp_eperm_v4(w, sel);
      zr = _fjsp_add_v4r8(v2, zr);
      zi = _fjsp_madd_v4r8(v1, tt, zi);
    } /* NLz */
  } /* NLy */
  } /* NLx */
  ...
  _fjsp_store_v4r8(vr, zr);
  _fjsp_store_v4r8(vi, zi);

  const double re = vr[0] + vr[1] + vr[2] + vr[3];
  const double im = vi[0] + vi[1] + vi[2] + vi[3];
